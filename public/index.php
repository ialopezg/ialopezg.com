...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            document.querySelector('form[name="subscriber-form"]').addEventListener('submit', async function (e) {
                e.preventDefault()

                formEnabled(e.target, false)

                if (formDirty(e.target, 'invalid')) {
                    const response = await doAction('index.php?a=subscriber', 'POST', {
